...
#'
#' For a given age interval, each spell is cut to fit into the
#' given age interval.
#'
#' @param dat Input data frame. Must contain survival data.
#' @param window Vector of length two: The age interval.
#' @param surv Vector of length three giving tha names of the central
#'    variables (a Surv object) in the dataframe 'dat'.
